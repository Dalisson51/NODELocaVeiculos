...
function desenhaTabela() {
    ...
    for (let i = 0; i < dados.length; i++) {
        ...
        td3.innerText = dados[i].veiculo.fabricante + ' ' + dados[i].veiculo.modelo + ' ' + dados[i].veiculo.cor + ' ' + dados[i].veiculo.litragem;
    ...
    fetch(`${urlBaseAPI}/veiculos`, opcoes)
        ...
        .then((json) => {
            ...
            for (let i = 0; i < json.length; i++) {
                ...
                option.innerText = json[i].fabricante + ' ' + json[i].modelo + ' ' + json[i].cor + ' ' + json[i].litragem;
